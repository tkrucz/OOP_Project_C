...
Grass::Grass(const Position &position) : Plant(0, position, grass) {}

void Grass::Action(vector<Cell> &cellList, vector<Organism *> &organismList, World &world, int &rows, int &columns) {
